...
import org.apache.storm.starter.tools.AbstractWeather.Weather;
import org.apache.storm.starter.tools.DailyForecast.Forecast.Temperature;
...
public class DailyForecast extends AbstractForecast {
	...
	public String getSQLQuery(String date, String hour, String file_name) {
		...
		sql.append("INSERT INTO w205_final.forecast_weather ");
		/*
		...
		for (Forecast forecast : forecastList) {
			...
			sql.append("' timestamp " + forecast.getDateTime() + "'" + ", ");
	...
	public String getFlattenedSQLQuery(String date, String hour, String file_name) {
		StringBuffer sql = new StringBuffer();
		sql.append("INSERT INTO w205_final.forecast_weather_flat ");
		/*
